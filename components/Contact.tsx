            ...
            >
                {[...Array(10)].map((_, i) => (
                    <div key={i} className="flex items-center shrink-0 mx-8">
                        <span className="text-[10vw] font-display font-bold uppercase tracking-tighter text-white mr-4">LET'S WORK</span>
                        <span className="text-[10vw] font-display font-bold uppercase tracking-tighter text-brand-green mr-16">TOGETHER</span>
                    </div>
                ))}
            </motion.div>
        </div>
